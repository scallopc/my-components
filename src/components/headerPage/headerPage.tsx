...
export default function HeaderPage() {
  ...
  const tenant = [
    {
      name: "Custamer 1",
      image:
        "https://i.pinimg.com/564x/41/98/bf/4198bf83cc056189d055fb4e03eac956.jpg",
      tenants: [
        {
          tname: "Tenant 1",
          image:
            "https://i.pinimg.com/564x/26/d9/d4/26d9d48b6cc679cbd5907081ee76b1f1.jpg",
        },
        {
          tname: "Tenant 2",
    ...
    },
    {
      name: "Custamer 2",
      image:
        "https://i.pinimg.com/564x/da/da/b5/dadab5c1a08117d7c7d22c27da788a55.jpg",
      tenants: [
        {
          tname: "Tenant 1",
  ...
  return (
    <>
      <Container>
        <ItemsContainer>
          <AppSwitch menu={menu} handleClick={(e) => console.log('menu', e)}/>

          <CascadeSelect
          className="cascadeTenant"
            value={selectedTenant}
            options={tenant}
            optionLabel={"tname"}
            optionGroupLabel={"name"}
            optionGroupChildren={["tenants"]}
            placeholder="Nome do Tenant A"
            onChange={onTenetChange}
